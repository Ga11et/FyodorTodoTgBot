...
TgBot.on("message", async (msg) => {
	...
	if (userMessage === "/menu") return await appController(chatId);
...
const againOptions = {
	reply_markup: JSON.stringify({
		inline_keyboard: [[{ text: "Сыграть снова", callback_data: "/again" }]],
	}),
};
...
const appController = async (chatId) => {
	await TgBot.sendMessage(chatId, "Мы открыли приложение!");
	return await TgBot.sendSticker(chatId, "CAACAgIAAxkBAAEGWcRjahIRsqLZsoFsn4xqzqgyLZJs2QAC1AQAAj6GlgY398e6at_soysE");
};
